...
errorbar(mean(AUC_test_over),std(AUC_test_over),'r','LineWidth',2)
xlabel('Stage - Dose Adjustment')
ylabel('AUC')

hold on;

errorbar(mean(AUC_test_under),std(AUC_test_under),'y','LineWidth',2)
xlabel('Stage - Dose Adjustment')
ylabel('AUC')

hold on;

errorbar(mean(AUC_test_ther),std(AUC_test_ther),'g','LineWidth',2)
xlabel('Stage - Dose Adjustment')
ylabel('AUC')
...
errorbar(mean(correct_rate),std(correct_rate),'b','LineWidth',2)
hold on;
errorbar(mean(correct_rate_doc),std(correct_rate_doc),'r','LineWidth',2)
