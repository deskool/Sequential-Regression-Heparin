...
%This is showing the mean SSE, and the standard error of the SSE.
...
%preds_dr is population
% preds_test is the individual
%% T TEST
for i = 1:8
    
    thing = 80*ones(1,3883)
...
for i = 1:8
    ...
    mdd(i) = nanmean(sqrt((Y_values(i,:)-80*ones(1,3883)).^2));
    sdd(i) = nanstd(sqrt((Y_values(i,:)-80*ones(1,3883)).^2))/sqrt(n(i));
...
savefig('Figure_Analysis_3_Continuous_all')

print -dpng -r300 Figure_Analysis_3_Continuous_all
...
print -dpng -r300 Figure_Comparison_of_dosing_errors_all
