...
for k = 1:length(res(1).X) %num_folds
    ...
    res_under_pred(k,:) = preds_test;
    res_under_test(k,:) = yc_test;   
    res_under_pvals(k,:) = pvals;
    k
end
save res_under_pvals res_under_pvals

save res_under_pred res_under_pred;
save res_under_test res_under_test;
